...
Nombre los tres tipos o categorías de patrones de diseño e indique
 uno o dos patrones en cada uno, explicando brevemente el patrón (máx. 2 líneas).
 */
...
Nombre los tres tipos o categorías de patrones de diseño e indique uno o dos patrones en cada uno,
explicando brevemente el patrón (máx. 2 líneas).

Creacionales: Resuelven problemas de creación de objetos

Singleton La intención del patrón consiste en garantizar que una clase sólo tenga una
única instancia y proporcionar un punto de acceso global a ella. El patrón singleton se implementa
creando en nuestra clase un método que crea una instancia del objeto sólo si todavía no existe alguna.
Para asegurar que la clase no puede ser instanciada nuevamente se regula el alcance del constructor (con visibilidad como protegido o privado).

Abstract Factory Permite trabajar con objetos de distintas familias de manera que las familias
...
de forma que cuando un objeto cambie de estado se notifique y actualicen automáticamente todos los objetos que dependen de él.
     */
}
